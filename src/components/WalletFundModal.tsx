      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        {isSavings ? (
          <>
            ...
            {targetOptions.length === 0 ? (
              ...
              <SelectField
                label={t('walletFund.storeAt')}
                modalTitle={t('walletFund.storeAt')}
                nested
          ...
          <>
            ...
            <SelectField
              label={t('walletFund.source')}
              modalTitle={t('walletFund.source')}
              nested
              value={source}
              onChange={setSource}
        ...
        <div>
          ...
          <input
            ...
            placeholder={isSavings ? t('walletFund.notePlaceholderSavings') : t('walletFund.notePlaceholderTopup')}
            className="w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] px-3.5 py-2.5 text-sm text-[var(--color-ink)] outline-none transition focus:border-[var(--color-primary)]"
          />
        </div>
